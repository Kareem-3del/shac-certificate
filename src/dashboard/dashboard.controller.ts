...
export class DashboardController {
  ...
  async showDashboard(
    ...
    try {
      ...
      const certificatesChart = await this.analyticsService.getCertificatesChartData();
  ...
  async showAdvertising(
    ...
    try {
      ...
      return res.render('dashboard/advertising', {
        ...
        pageDescription: 'Monitor your advertising campaigns and return on investment',
        includeChartJS: true,
        user: currentUser,
        campaigns,
        roiBreakdown,
  ...
  async showUsersList(
    ...
    try {
      ...
      return res.render('dashboard/users/list', {
        ...
        breadcrumbs: [{ label: 'Users', url: '/dashboard/users' }, { label: 'All Users' }],
        user: currentUser,
        users,
        userStats
      });
  ...
  async showUser(
    ...
    try {
      ...
      return res.render('dashboard/users/view', {
        ...
        breadcrumbs: [{ label: 'Users', url: '/dashboard/users' }, { label: 'All Users', url: '/dashboard/users/list' }, { label: user.username }],
        user: currentUser,
        targetUser: user
      });
    } catch (error) {
  ...
  async showEditUser(
    ...
    try {
      ...
      return res.render('dashboard/users/edit', {
        ...
        breadcrumbs: [{ label: 'Users', url: '/dashboard/users' }, { label: 'All Users', url: '/dashboard/users/list' }, { label: user.username, url: `/dashboard/users/${id}` }, { label: 'Edit' }],
        user: currentUser,
        targetUser: user
      });
    } catch (error) {
  ...
  async updateUser(
    ...
    try {
      ...
      if (updateData.role && currentUser.role === 'admin') user.role = updateData.role;
      if (updateData.points !== undefined) user.points = parseInt(updateData.points);
  ...
  async showCertificatesList(
    ...
    try {
      ...
      const certificateStats = await this.analyticsService.getCertificateStats();
      ...
      return res.render('dashboard/certificates/list', {
        ...
        breadcrumbs: [{ label: 'Certificates', url: '/dashboard/certificates' }, { label: 'All Certificates' }],
        user: currentUser,
        certificates,
        certificateStats
      });
  ...
  async showCertificate(
    ...
    try {
      ...
      return res.render('dashboard/certificates/view', {
        ...
        breadcrumbs: [{ label: 'Certificates', url: '/dashboard/certificates' }, { label: 'All Certificates', url: '/dashboard/certificates/list' }, { label: certificate.name }],
        user: currentUser,
        certificate
      });
    } catch (error) {
  ...
  async showSubscriptions(
    ...
    try {
      ...
      const monthlyRevenue = await this.subscriptionsService.calculateMonthlyRevenue();
      const activeSubscriptionsCount = await this.subscriptionsService.getActiveSubscriptions();
      const newSubscriptions = await this.subscriptionsService.totalSubscriptions(thirtyDaysAgo);
      const recentSubscriptions = await this.subscriptionsService.recentSubscriptions();
      const mostSubscribed = await this.subscriptionsService.getMostSubscribed(thirtyDaysAgo);
  ...
  async showTransactions(
    ...
    try {
      ...
      const recentTransactions = await this.analyticsService.getRecentActivity();
      const chartData = await this.analyticsService.getRevenueChartData();

      // Filter only payment activities
      const transactions = recentTransactions.filter(activity => activity.type === 'payment');
